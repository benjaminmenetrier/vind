...
// -----------------------------------------------------------------------------
///  LinarModelPython class

class __attribute__((visibility("hidden"))) LinearModelPython:
  public LinearModelBase,
  private util::ObjectCounter<LinearModelPython> {
 public:
  static const std::string classname() {return "vind::LinearModelPython";}
